...
![Claude](https://img.shields.io/badge/Claude-Sonnet--4--6-orange?logo=anthropic)
![TypeScript](https://img.shields.io/badge/TypeScript-E2E%20Tests-blue?logo=typescript)
![Python](https://img.shields.io/badge/Python-MLOps%20Stack-green?logo=python)
![TruLens](https://img.shields.io/badge/TruLens-Monitoring-purple)
![LangSmith](https://img.shields.io/badge/LangSmith-Tracing-red)
![MLflow](https://img.shields.io/badge/MLflow-Experiments-blue)
![Pinecone](https://img.shields.io/badge/Pinecone-Vector%20Search-teal)
![HuggingFace](https://img.shields.io/badge/🤗%20Demo-Live-yellow)
![Stars](https://img.shields.io/github/stars/vijayarjun7/ai-qe-agent?style=social)
...
Built a custom **LLM-as-Judge eval suite** on top of the pipeline —
...
```bash
npm run eval                    # TypeScript LLM-as-judge eval suite
python trulens_monitor.py       # TruLens dashboard  →  localhost:8501
python langsmith_tracer.py      # LangSmith traces   →  smith.langchain.com
python mlflow_tracker.py        # MLflow experiments →  localhost:5050
mlflow ui --backend-store-uri sqlite:///mlflow.db --port 5050
```

### Key Finding

> **AI systems fail silently.** SelfHealingAgent scored 1.0 quality
> but 0.0 faithfulness — output looked correct, process was wrong.
> Only an eval layer catches this distinction.

---

## 🤗 Live Demo

Try the Playwright test generator and self-healing UI live on Hugging Face Spaces:

**[https://huggingface.co/spaces/Vijayarv07/ai-qe-agent](https://huggingface.co/spaces/Vijayarv07/ai-qe-agent)**
